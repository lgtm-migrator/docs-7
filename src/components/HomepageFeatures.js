...
const FeatureList = [
  {
    ...
    description: (
      <>
        Flocon（フロコン）は、個人サーバー（自鯖）に設置して利用できる新世代のTRPGオンラインセッションツールです。自鯖運用にフォーカスしたツールですが、公開サーバーとしての運用にも対応しています。
      </>
    ),
  },
  {
    ...
    description: (
      <>
        FloconのTRPGオンラインセッションツールは、開発が終了したどどんとふの後継ツールとして有力な選択肢の1つになることを目指して、多機能かつ自鯖運用可能であることを意識して開発しています。今後もできる限り全力で継続的に機能追加を行っていきます。
      </>
    ),
  },
  {
